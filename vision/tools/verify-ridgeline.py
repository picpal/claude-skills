...
Usage:
    python3 tools/verify-ridgeline.py --all
    python3 tools/verify-ridgeline.py assets/example-ridgeline.html
...
ACCENTS = {"#0f766e", "#14b8a6"}   # light and dark skin accent tokens (vision fork)
