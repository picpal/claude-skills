...
Usage:
    python3 tools/verify-bubble.py --all
    python3 tools/verify-bubble.py assets/example-bubble.html
...
ACCENT_RE = re.compile(
    r"#0f766e\b|#14b8a6\b|rgba\(\s*15\s*,\s*118\s*,\s*110\b|rgba\(\s*20\s*,\s*184\s*,\s*166\b",
    re.IGNORECASE,
)
