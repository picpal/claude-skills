...
- **Set labels** placed outside the circle, NEVER crossing the stroke. Pretendard 12–14px 600 for the set name, optional Geist Mono 9px sublabel.
- **Intersection labels** placed inside the overlap region, Pretendard 12px 600, centered. For small overlaps, use a leader line to a label in clear space.
- **Accent accent** on the ONE focal intersection — the "sweet spot". Either accent label stroke OR clipPath-bounded accent fill tint (`rgba(15,118,110,0.10)`).
