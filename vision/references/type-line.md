...
<polyline points="x0,y0 x1,y1 x2,y2 ..."
          fill="none" stroke="#0f766e" stroke-width="1.8" stroke-linejoin="round"/>
...
**Both axes must carry the same scale and the same units.** That is the entire claim of the type: if the scales differ, the angle of every line is fiction. `tools/verify-slopegraph.py` gates it.
...
<line data-series="Recommender" data-from="238" data-to="431"
      x1="320" y1="303.5" x2="680" y2="140.5" stroke="#0f766e" stroke-width="2.4"/>
<circle cx="320" cy="303.5" r="4" fill="#0f766e"/>
<circle cx="680" cy="140.5" r="4" fill="#0f766e"/>
<text data-series="Recommender" data-end="from" data-role="name" x="272" y="307" fill="#2d3142" font-size="11" font-weight="600" font-family="'Pretendard', 'Noto Sans KR', sans-serif" text-anchor="end">Recommender</text>
...
<text data-series="Recommender" data-end="to" data-role="name" x="728" y="144" fill="#2d3142" font-size="11" font-weight="600" font-family="'Pretendard', 'Noto Sans KR', sans-serif">Recommender</text>
```
...
`tools/verify-slopegraph.py` requires all of them, cross-checks each visible string against its binding, and reports any label drawn nearer another series' endpoint than its own — a label on the wrong row renames the line.
...
<path data-ridge="checkout-api" data-baseline="320" data-bins="0,1,6,17,21,14,8,6,7,9,7,4,0" d="M320,320 L350,317.6 L380,305.6 L410,279.2 L440,269.6 L470,286.4 L500,300.8 L530,305.6 L560,303.2 L590,298.4 L620,303.2 L650,310.4 L680,320 Z" fill="rgba(15,118,110,0.16)" stroke="#0f766e" stroke-width="2.4" stroke-linejoin="round"/>
<text data-ridge="checkout-api" data-role="name" x="304" y="323.5" fill="#2d3142" font-size="11" font-weight="600" font-family="'Pretendard', 'Noto Sans KR', sans-serif" text-anchor="end">checkout-api</text>
