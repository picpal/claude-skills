...
```svg
<!-- 1. Italic Pretendard text -->
<text x="904" y="36" fill="#2d3142" font-size="14" font-style="italic"
      font-family="'Pretendard', 'Noto Sans KR', sans-serif" text-anchor="end">no imports, no configuration</text>
...
| Focal / accent | accent `#0f766e` | `rgba(15,118,110,0.50)` |
