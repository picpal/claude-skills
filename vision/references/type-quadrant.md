...
A **layout variant** of the standard quadrant — same house skin (warm paper, dot pattern, Pretendard title, Geist mono eyebrows, accent focal rule). The grammar shifts: axes hold a **range** rather than a measurement; cells hold **named scenarios** rather than positioned items.
...
- **Focal quadrant tint**: `rgba(15,118,110,0.04)` full rect behind the focal cell.
...
- **Cell title**: Pretendard, 16px, weight 600, `ink`.
- **Cell description**: Pretendard, 11px, `muted`, 1–3 lines, left-aligned inside the cell.
...
- Undersized H1 — keep the page title at 1.75rem/600 Pretendard. The size jump from the 12px node labels is the house signature; this fork carries no serif to carry it instead.
