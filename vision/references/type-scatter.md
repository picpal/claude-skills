...
<circle cx="X" cy="Y" r="6" fill="rgba(15,118,110,0.15)" stroke="#0f766e" stroke-width="1.2"/>
```
...
**Area encodes the third value — never radius.** Radius-proportional sizing squares the claim: a 6× value reads as 36× the ink. `tools/verify-bubble.py` gates it, along with the two axis scales.
...
<circle data-name="Payments" data-x="260" data-y="2.8" data-size="760"
        ...
        fill="rgba(15,118,110,0.15)" stroke="#0f766e" stroke-width="1.2"/>
