...
- **Left label column:** x=20–200 (180px). Task names in Pretendard 11px 600. Phase labels as Geist Mono 7px eyebrows above each group.
...
<text x="X_start+8" y="ROW_Y+25" fill="#2d3142" font-size="10" font-weight="600"
      font-family="'Pretendard', 'Noto Sans KR', sans-serif">Task name</text>

<!-- Focal task -->
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(15,118,110,0.12)" stroke="#0f766e" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#0f766e" font-size="10" font-weight="600"
      font-family="'Pretendard', 'Noto Sans KR', sans-serif">Key task</text>
```
