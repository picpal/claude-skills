...
- Focal fill: `rgba(15,118,110,0.20)`, number text accent (§5).
...
- Focal fill: accent (`#0f766e` light / `#14b8a6` dark).
...
| `focal-in` / `focal-out` | `#0f766e` (accent) | 1.2 | — | `arrow-accent` | Every edge whose endpoint is the focal node (`focal-in`) or origin is the focal node (`focal-out`). |
...
| Focal chip fill | `rgba(15,118,110,0.20)` | `rgba(20,184,166,0.22)` |
| Default node fill | white | `rgba(245,245,245,0.04)` |
| Default node stroke | `rgba(45,49,66,0.25)` | `rgba(245,245,245,0.20)` |
| Focal node fill | `rgba(15,118,110,0.08)` | `rgba(20,184,166,0.12)` |
| Focal node stroke | `#0f766e` | `#14b8a6` |
