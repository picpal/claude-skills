...
- Icon set (server, DB, bucket, query, schedule, dashboard, notebook, …) → [primitive-icons.md](references/primitive-icons.md). Browse the gallery at [`assets/icons.html`](assets/icons.html), regenerated by `python3 tools/build-icons.py`.
